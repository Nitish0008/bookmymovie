        ...
        {selectedSeats.length > 0 && (
          <div className="mt-2 flex justify-center gap-2 items-center flex-col">
            ...
            {/* <StripeCheckout
              ...
              billingAddress
              stripeKey="pk_test_51N9VwISDOovIT2Jmbi11jqCZ1nqua7s3RoBHi9NlIior2UGaDxeN9rhR0AB8HzxH3FEgwEgEhqvA7CXdPxbakK1C008zhdXhOj"
            >
              <Button title="Book Now" />
            </StripeCheckout> */}

            <Button title="Book now" onClick={()=>onToken()}/>
          </div>
        )}
      </div>
    )
